...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (isset($_POST["Name"]) && isset($_POST["Email"]) && isset($_POST["Age"]) && isset($_POST["Gender"]) && isset($_POST["Password"]) && isset($_POST["ClassID"])) {
        $name = $_POST["Name"];
        $email = $_POST["Email"];
        $age = $_POST["Age"];
        $gender = $_POST["Gender"];
        ...
        if (!empty($name) && !empty($email) && !empty($age) && !empty($gender) && !empty($password)) {
            ...
            generateHttpResponse(201, "Success", "User Created Successfully", ["Token" => $jwt]);
            return;
